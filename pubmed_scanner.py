...
[具體指令] 閱讀提供的論文標題與原始摘要，將核心資訊提煉為 100 至 150 字的繁體中文重點摘要。請依序產出三個區塊：1. 💡 痛點與背景、2. 🔍 核心AI發現、3. 🚀 應用與意義。

標題：{title}
原始摘要：{abstract}

[約束條件] 全面使用精簡的條列式或短分段排版，段落間保留空白行。每段開頭結合適當的 Emoji 提升視覺引導與手機閱讀體驗。語氣保持專業、易懂且充滿活力，字數嚴格控制在 100 至 150 字之間。"""
